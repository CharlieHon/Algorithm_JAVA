...
import static com.charlie.algorithm.recursion_multi.E01Fibonacci.fibonacci;
import static com.charlie.algorithm.recursion_multi.E01Fibonacci.fibonacci2;
...
public class TestE01Fibonacci {
    ...
    public void test2() {
        ...
        ns         %     Task name
        ---------------------------------------------
        000198000  000%  带 cache
        374625300  100%  不带 cache
         */
